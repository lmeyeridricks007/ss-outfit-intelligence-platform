...
| Ecommerce surface experiences | PDP, cart, expanded web placements: UX, modules, states, integration to delivery API. | P1 / P2 | Shared contracts; complete-look; analytics; catalog freshness; commerce APIs; context expansion | `ecommerce-surface-experiences.md` | BR-003, BR-001, BR-002, BR-010 |
