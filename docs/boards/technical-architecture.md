...
| TA-006 | Catalog and inventory ingestion technical architecture | APPROVED | HUMAN_REQUIRED | Architecture Agent | Review Agent | Issue-created automation | FEAT-001 / F1 | `docs/architecture/catalog-and-inventory-ingestion-technical-architecture.md` | Architecture artifact complete; review threshold met; implementation planning may start from TA-006 | Autonomous mode ON: board set to APPROVED after self-review; PR open; follow-ups captured in TA-006 §9; promotes to IP-001 |
